...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovups	32(%r15,%rcx,4), %ymm1
	vmovups	64(%r15,%rcx,4), %ymm2
	vmovups	96(%r15,%rcx,4), %ymm3
	...
	vmovups	%ymm1, 32(%rbx,%rcx,4)
	vmovups	%ymm2, 64(%rbx,%rcx,4)
	vmovups	%ymm3, 96(%rbx,%rcx,4)
	addq	$32, %rcx
